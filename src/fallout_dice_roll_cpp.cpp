...
int main(int argc, char* argv[])
{
	...
	std::cout << fallout_dicelib::combat_dice::roll(rng, 10).to_report_string() << "\n";
	std::cout << fallout_dicelib::combat_dice::from_dice_rolls({1, 2, 3, 4, 5, 6}).to_report_string() << "\n";
	std::cout << fallout_dicelib::combat_dice::from_dice_rolls(1, 2U).to_report_string() << "\n";
